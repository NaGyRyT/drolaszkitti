		...
		var loadIframe		=	function()
							{
								...
								else
								{
									...
									if(isStaffPage){
										...
										jQuery("#iframeContent").html('<iframe id="setmore-fancy-box-iframe" frameborder="0" hspace="0" scrolling="auto" src="https://booking.setmore.com/scheduleappointment/'+staffKey+'"></iframe>');
									}
									else if(isServicePage){
										var serviceIndex = bookingPageInfo.indexOf("services");
										var serviceKey = bookingPageInfo[serviceIndex+1];
										if(serviceKey)
											jQuery("#iframeContent").html('<iframe id="setmore-fancy-box-iframe" frameborder="0" hspace="0" scrolling="auto" src="https://booking.setmore.com/scheduleappointment/'+k+'/services/'+serviceKey+'"></iframe>');
										else
											jQuery("#iframeContent").html('<iframe id="setmore-fancy-box-iframe"  frameborder="0" hspace="0" scrolling="auto" src="https://booking.setmore.com/scheduleappointment/'+k+'/services"></iframe>');
									}
									else if(isClassPage){
										var classIndex = bookingPageInfo.indexOf("class");
										var classKey = bookingPageInfo[classIndex+1];
										if(classKey)
											jQuery("#iframeContent").html('<iframe id="setmore-fancy-box-iframe" frameborder="0" hspace="0" scrolling="auto" src="https://booking.setmore.com/scheduleappointment/'+k+'/class/'+classKey+'"></iframe>');
										else
											jQuery("#iframeContent").html('<iframe id="setmore-fancy-box-iframe" frameborder="0" hspace="0" scrolling="auto" src="https://booking.setmore.com/scheduleappointment/'+k+'/class"></iframe>');
									}
									else if(isClassBooking){
										jQuery("#iframeContent").html('<iframe id="setmore-fancy-box-iframe" frameborder="0" hspace="0" scrolling="auto" src="https://booking.setmore.com/scheduleappointment/'+k+'/bookclass"></iframe>');
									}
									else if(isServiceBooking){
										jQuery("#iframeContent").html('<iframe id="setmore-fancy-box-iframe" frameborder="0" hspace="0" scrolling="auto" src="https://booking.setmore.com/scheduleappointment/'+k+'/bookappointment"></iframe>');
									}
									else{
										jQuery("#iframeContent").html('<iframe id="setmore-fancy-box-iframe" frameborder="0" hspace="0" scrolling="auto" src="https://booking.setmore.com/scheduleappointment/'+k+'"></iframe>');
									}
